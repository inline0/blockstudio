...
test.describe('component-innerblocks-richtext-twig', () => {
	test('add block', async () => {
		await addBlock(page, 'component-innerblocks-richtext-twig');
	...
	test('add content', async () => {
		await canvas.click('.is-root-container > .wp-block > div > [contenteditable]');
