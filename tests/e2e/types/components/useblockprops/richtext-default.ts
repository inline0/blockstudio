...
test.describe('component-useblockprops-richtext-default', () => {
	test('add block', async () => {
		await addBlock(page, 'component-useblockprops-richtext-default');
	...
	test('check wrapper', async () => {
		...
		await canvas.click('[data-type="blockstudio/component-useblockprops-richtext-default"]');
	...
	test('check content', async () => {
		...
		await count(page, '.wp-block-blockstudio-component-useblockprops-richtext-default', 1);
