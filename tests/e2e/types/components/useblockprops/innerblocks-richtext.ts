...
test.describe('component-useblockprops-innerblocks-richtext', () => {
	test('add block', async () => {
		await addBlock(page, 'component-useblockprops-innerblocks-richtext');
	...
	test('check content', async () => {
		...
		await count(page, '.blockstudio-test__block.test.test2.test3', 1);
		await count(page, '.blockstudio-test__block.test.test2.test3.test4', 0);
		await count(page, '.wp-block-blockstudio-component-useblockprops-innerblocks-richtext', 1);
