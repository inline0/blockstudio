...
test.describe('component-useblockprops-innerblocks-default', () => {
	test('add block', async () => {
		await addBlock(page, 'component-useblockprops-innerblocks-default');
	...
	test('check content', async () => {
		...
		await count(page, '.wp-block-blockstudio-component-useblockprops-innerblocks-default', 1);
	});
});
