...
test.describe('component-useblockprops-richtext-default-twig', () => {
	test('add block', async () => {
		await addBlock(page, 'component-useblockprops-richtext-default-twig');
	...
	test('check wrapper', async () => {
		...
		await canvas.click('[data-type="blockstudio/component-useblockprops-richtext-default-twig"]');
		await page.keyboard.type('Test text');
		await count(canvas, '.is-root-container > [contenteditable]', 1);
	...
	test('check content', async () => {
		...
		await count(page, '.wp-block-blockstudio-component-useblockprops-richtext-default-twig', 1);
