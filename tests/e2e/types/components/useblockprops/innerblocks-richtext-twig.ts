...
test.describe('component-useblockprops-innerblocks-richtext-twig', () => {
	test('add block', async () => {
		await addBlock(page, 'component-useblockprops-innerblocks-richtext-twig');
	...
	test('check wrapper', async () => {
		...
		await count(page, '.is-root-container > .wp-block', 1);
		await count(page, '.is-root-container > .wp-block > [data-is-drop-zone]', 1);
		await count(page, '.is-root-container > .wp-block > [contenteditable]', 1);
		await page.click('.is-root-container > .wp-block > [contenteditable]');
	...
	test('check content', async () => {
		...
		await count(page, '.blockstudio-test__block.test.test2.test3', 1);
		await count(page, '.blockstudio-test__block.test.test2.test3.test4', 0);
		await count(page, '.wp-block-blockstudio-component-useblockprops-innerblocks-richtext-twig', 1);
