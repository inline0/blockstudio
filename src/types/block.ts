...
const typeMap: any = {
  Block: o(
    [
      ...
      { json: 'apiVersion', js: 'apiVersion', typ: u(undefined, 0) },
      {
        json: 'attributes',
        js: 'attributes',
        typ: u(undefined, r('Attributes')),
      },
      {
        json: 'blockHooks',
        js: 'blockHooks',
        typ: u(undefined, r('BlockHooks')),
      },
      {
        json: 'blockstudio',
        js: 'blockstudio',
        typ: u(undefined, u(true, r('BlockstudioClass'))),
      },
    ...
    [
      {
        json: 'attributes',
        js: 'attributes',
        typ: u(undefined, a(r('BlockstudioAttribute'))),
      },
      {
        json: 'blockEditor',
        js: 'blockEditor',
        typ: u(undefined, r('BlockstudioBlockEditor')),
      },
      {
        json: 'conditions',
        js: 'conditions',
    ...
    [
      {
        json: 'conditions',
        js: 'conditions',
        typ: u(undefined, a(a(r('StickyCondition')))),
      },
      { json: 'description', js: 'description', typ: u(undefined, '') },
      ...
      { json: 'type', js: 'type', typ: r('FluffyType') },
      {
        json: 'default',
        js: 'default',
        typ: u(undefined, u(a('any'), true, 3.14, m('any'), '')),
      },
      {
        json: 'fallback',
        js: 'fallback',
      ...
      { json: 'media', js: 'media', typ: u(undefined, true) },
      {
        json: 'options',
        js: 'options',
        typ: u(undefined, a(r('FluffyOption'))),
      },
      {
        json: 'populate',
        js: 'populate',
        typ: u(undefined, r('FluffyPopulate')),
      },
      {
        json: 'returnFormat',
        js: 'returnFormat',
        typ: u(undefined, r('ReturnFormatEnum')),
      },
      ...
      {
        json: 'disableCustomColors',
        js: 'disableCustomColors',
      ...
      {
        json: 'disableCustomGradients',
        js: 'disableCustomGradients',
        typ: u(undefined, true),
      },
      {
        json: 'attributes',
        js: 'attributes',
        typ: u(undefined, a(r('AttributeAttribute'))),
      },
      ...
      {
        json: 'resetFallbackValue',
        js: 'resetFallbackValue',
        typ: u(undefined, 3.14),
      },
      {
        json: 'separatorType',
        js: 'separatorType',
        typ: u(undefined, r('SeparatorType')),
      },
      ...
      { json: 'rows', js: 'rows', typ: u(undefined, 3.14) },
      {
        json: 'textMinimized',
        js: 'textMinimized',
        typ: u(undefined, u(r('FluffyTextMinimized'), '')),
      },
      { json: 'textRemove', js: 'textRemove', typ: u(undefined, u(true, '')) },
      { json: 'disableUnits', js: 'disableUnits', typ: u(undefined, true) },
      {
        json: 'isPressEnterToChange',
        js: 'isPressEnterToChange',
        typ: u(undefined, true),
      },
      {
        json: 'isResetValueOnUnitChange',
        js: 'isResetValueOnUnitChange',
        typ: u(undefined, true),
      },
      {
        json: 'isUnitSelectTabbable',
        js: 'isUnitSelectTabbable',
        typ: u(undefined, true),
      },
    ...
    [
      {
        json: 'conditions',
        js: 'conditions',
        typ: u(undefined, a(a(r('FluffyCondition')))),
      },
      { json: 'description', js: 'description', typ: u(undefined, '') },
      { json: 'help', js: 'help', typ: u(undefined, '') },
      { json: 'hidden', js: 'hidden', typ: u(undefined, true) },
      ...
      { json: 'media', js: 'media', typ: u(undefined, true) },
      {
        json: 'options',
        js: 'options',
        typ: u(undefined, a(r('PurpleOption'))),
      },
      {
        json: 'populate',
        js: 'populate',
        typ: u(undefined, r('PurplePopulate')),
      },
      {
        json: 'returnFormat',
        js: 'returnFormat',
      ...
      { json: 'rows', js: 'rows', typ: u(undefined, 3.14) },
      {
        json: 'attributes',
        js: 'attributes',
        typ: u(undefined, a(r('Attribute'))),
      },
      {
        json: 'textMinimized',
        js: 'textMinimized',
        typ: u(undefined, u(r('PurpleTextMinimized'), '')),
      },
      { json: 'textRemove', js: 'textRemove', typ: u(undefined, u(true, '')) },
      { json: 'disableUnits', js: 'disableUnits', typ: u(undefined, true) },
      {
  ...
  AttributeTab: o(
    [
      ...
      },
      {
        json: 'blockEditor',
        js: 'blockEditor',
        typ: u(undefined, r('PurpleBlockEditor')),
      },
      {
        json: 'conditions',
        js: 'conditions',
        typ: u(undefined, a(a(r('PurpleCondition')))),
      },
      ...
      { json: 'title', js: 'title', typ: '' },
      {
        json: 'transforms',
        js: 'transforms',
        typ: u(undefined, r('PurpleTransforms')),
      },
    ],
    'any',
  ),
    ...
    [
      {
        json: 'conditions',
        js: 'conditions',
        typ: u(undefined, a(a(r('AttributeCondition')))),
      },
      { json: 'description', js: 'description', typ: u(undefined, '') },
      { json: 'help', js: 'help', typ: u(undefined, '') },
      { json: 'hidden', js: 'hidden', typ: u(undefined, true) },
      ...
      { json: 'media', js: 'media', typ: u(undefined, true) },
      {
        json: 'options',
        js: 'options',
        typ: u(undefined, a(r('AttributeOption'))),
      },
      {
        json: 'populate',
        js: 'populate',
        typ: u(undefined, r('AttributePopulate')),
      },
      {
        json: 'returnFormat',
        js: 'returnFormat',
      ...
      { json: 'units', js: 'units', typ: u(undefined, a(r('AttributeUnit'))) },
      {
        json: 'toolbar',
        js: 'toolbar',
        typ: u(undefined, r('AttributeToolbar')),
      },
    ],
    'any',
  ),
  ...
  AttributeOption: o(
    [
      ...
      { json: 'slug', js: 'slug', typ: u(undefined, '') },
      {
        json: 'innerBlocks',
        js: 'innerBlocks',
        typ: u(undefined, a(r('InnerBlockElement'))),
      },
    ],
    'any',
  ),
    ...
    [
      {
        json: 'arguments',
        js: 'arguments',
        typ: u(undefined, u(a('any'), r('PurpleArguments'))),
      },
      ...
      { json: 'function', js: 'function', typ: u(undefined, '') },
      {
        json: 'position',
        js: 'position',
        typ: u(undefined, r('PositionEnum')),
      },
      { json: 'query', js: 'query', typ: u(undefined, r('Query')) },
      {
        json: 'returnFormat',
        js: 'returnFormat',
        typ: u(undefined, r('PurpleReturnFormat')),
      },
  ...
  PurpleFormats: o(
    [
      ...
      { json: 'strikethrough', js: 'strikethrough', typ: u(undefined, true) },
      {
        json: 'textAlign',
        js: 'textAlign',
        typ: u(undefined, r('PurpleTextAlign')),
      },
    ...
    [
      {
        json: 'arguments',
        js: 'arguments',
        typ: u(undefined, u(a('any'), r('FluffyArguments'))),
      },
      { json: 'custom', js: 'custom', typ: u(undefined, '') },
      { json: 'function', js: 'function', typ: u(undefined, '') },
      {
      ...
      { json: 'query', js: 'query', typ: u(undefined, r('Query')) },
      {
        json: 'returnFormat',
        js: 'returnFormat',
        typ: u(undefined, r('FluffyReturnFormat')),
      },
      { json: 'type', js: 'type', typ: u(undefined, r('PopulateType')) },
      { json: 'fetch', js: 'fetch', typ: u(undefined, true) },
    ],
  ...
  PurpleTab: o(
    [
      ...
      },
      {
        json: 'blockEditor',
        js: 'blockEditor',
        typ: u(undefined, r('FluffyBlockEditor')),
      },
      {
        json: 'conditions',
        js: 'conditions',
        typ: u(undefined, a(a(r('TentacledCondition')))),
      },
      ...
      { json: 'title', js: 'title', typ: '' },
      {
        json: 'transforms',
        js: 'transforms',
        typ: u(undefined, r('FluffyTransforms')),
      },
    ],
    'any',
  ),
  ...
  FluffyFormats: o(
    [
      ...
      { json: 'strikethrough', js: 'strikethrough', typ: u(undefined, true) },
      {
        json: 'textAlign',
        js: 'textAlign',
        typ: u(undefined, r('FluffyTextAlign')),
      },
      { json: 'underline', js: 'underline', typ: u(undefined, true) },
      { json: 'unorderedList', js: 'unorderedList', typ: u(undefined, true) },
    ],
    ...
    [
      {
        json: 'arguments',
        js: 'arguments',
        typ: u(undefined, u(a('any'), r('TentacledArguments'))),
      },
      { json: 'custom', js: 'custom', typ: u(undefined, '') },
      { json: 'function', js: 'function', typ: u(undefined, '') },
      {
      ...
      { json: 'query', js: 'query', typ: u(undefined, r('Query')) },
      {
        json: 'returnFormat',
        js: 'returnFormat',
        typ: u(undefined, r('TentacledReturnFormat')),
      },
      { json: 'type', js: 'type', typ: u(undefined, r('PopulateType')) },
      { json: 'fetch', js: 'fetch', typ: u(undefined, true) },
    ],
  ...
  FluffyTab: o(
    [
      ...
      },
      {
        json: 'blockEditor',
        js: 'blockEditor',
        typ: u(undefined, r('TentacledBlockEditor')),
      },
      {
        json: 'conditions',
        js: 'conditions',
        typ: u(undefined, a(a(r('IndigoCondition')))),
      },
      ...
      { json: 'title', js: 'title', typ: '' },
      {
        json: 'transforms',
        js: 'transforms',
        typ: u(undefined, r('TentacledTransforms')),
      },
    ],
    'any',
  ),
    ...
    [
      {
        json: 'formats',
        js: 'formats',
        typ: u(undefined, r('TentacledFormats')),
      },
  ...
  TentacledFormats: o(
    [
      ...
      { json: 'strikethrough', js: 'strikethrough', typ: u(undefined, true) },
      {
        json: 'textAlign',
        js: 'textAlign',
        typ: u(undefined, r('TentacledTextAlign')),
      },
      { json: 'underline', js: 'underline', typ: u(undefined, true) },
      { json: 'unorderedList', js: 'unorderedList', typ: u(undefined, true) },
    ],
    ...
    [
      {
        json: 'border',
        js: 'border',
        typ: u(undefined, u(r('BorderObject'), '')),
      },
      { json: 'color', js: 'color', typ: u(undefined, u(r('ColorColor'), '')) },
      {
        json: 'dimensions',
        js: 'dimensions',
        typ: u(undefined, u(r('DimensionsDimensions'), '')),
      },
      { json: 'root', js: 'root', typ: u(undefined, '') },
      {
        json: 'spacing',
        js: 'spacing',
        typ: u(undefined, u(r('SpacingSpacing'), '')),
      },
      {
        json: 'typography',
        js: 'typography',
        typ: u(undefined, u(r('TypographyTypography'), '')),
      },
    ],
    'any',
  ),
    ...
    [
      {
        json: 'align',
        js: 'align',
        typ: u(undefined, u(a(r('AlignElement')), true)),
      },
      ...
      },
      {
        json: 'dimensions',
        js: 'dimensions',
        typ: u(undefined, r('SupportsDimensions')),
      },
      ...
      { json: 'inserter', js: 'inserter', typ: u(undefined, true) },
      {
        json: 'interactivity',
        js: 'interactivity',
        typ: u(undefined, u(true, r('InteractivityObject'))),
      },
      {
        json: 'layout',
        js: 'layout',
        typ: u(undefined, u(true, r('LayoutObject'))),
      },
      ...
      { json: 'multiple', js: 'multiple', typ: u(undefined, true) },
      {
        json: 'position',
        js: 'position',
        typ: u(undefined, r('PositionObject')),
      },
      ...
      { json: 'shadow', js: 'shadow', typ: u(undefined, u(true, m('any'))) },
      {
        json: 'spacing',
        js: 'spacing',
        typ: u(undefined, r('SupportsSpacing')),
      },
      { json: 'splitting', js: 'splitting', typ: u(undefined, true) },
      {
        json: 'typography',
        js: 'typography',
        typ: u(undefined, r('SupportsTypography')),
      },
    ],
    'any',
  ),
  ...
  SupportsColor: o(
    [
      ...
      {
        json: 'enableContrastChecker',
        js: 'enableContrastChecker',
        typ: u(undefined, true),
      },
  ...
  LayoutObject: o(
    [
      {
        json: 'allowCustomContentAndWideSize',
        js: 'allowCustomContentAndWideSize',
        typ: u(undefined, true),
      },
      { json: 'allowEditing', js: 'allowEditing', typ: u(undefined, true) },
      {
        json: 'allowInheriting',
        js: 'allowInheriting',
        typ: u(undefined, true),
      },
      {
        json: 'allowJustification',
        js: 'allowJustification',
        typ: u(undefined, true),
      },
      {
        json: 'allowOrientation',
        js: 'allowOrientation',
        typ: u(undefined, true),
      },
      {
        json: 'allowSizingOnChildren',
        js: 'allowSizingOnChildren',
        typ: u(undefined, true),
      },
      { json: 'allowSwitching', js: 'allowSwitching', typ: u(undefined, true) },
      {
        json: 'allowVerticalAlignment',
        js: 'allowVerticalAlignment',
        typ: u(undefined, true),
      },
  ...
  DefaultObject: o(
    [
      ...
      { json: 'flexWrap', js: 'flexWrap', typ: u(undefined, r('FlexWrap')) },
      {
        json: 'justifyContent',
        js: 'justifyContent',
        typ: u(undefined, r('JustifyContent')),
      },
      {
        json: 'minimumColumnWidth',
        js: 'minimumColumnWidth',
        typ: u(undefined, ''),
      },
      {
        json: 'orientation',
        js: 'orientation',
        typ: u(undefined, r('Orientation')),
      },
      { json: 'type', js: 'type', typ: u(undefined, r('DefaultType')) },
      {
        json: 'verticalAlignment',
        js: 'verticalAlignment',
        typ: u(undefined, r('VerticalAlignment')),
      },
    ...
    [
      {
        json: 'margin',
        js: 'margin',
        typ: u(undefined, u(a(r('MarginElement')), true)),
      },
      {
        json: 'padding',
        js: 'padding',
  ...
  SupportsTypography: o(
    [
      ...
      { json: 'lineHeight', js: 'lineHeight', typ: u(undefined, true) },
      {
        json: 'textAlign',
        js: 'textAlign',
        typ: u(undefined, u(a(r('TextAlignElement')), true)),
      },
    ],
    'any',
  ),
  ...
  FromType: ['block', 'enter', 'prefix'],
  DragDirection: ['e', 'n', 's', 'w'],
  Language: ['css', 'html', 'json', 'javascript', 'twig'],
  PositionEnum: ['after', 'before'],
  Query: ['posts', 'terms', 'users'],
  PopulateType: ['custom', 'fetch', 'function', 'query'],
  ReturnFormatEnum: [
    'both',
    'element',
    'id',
  ...
  SeparatorType: ['fullWidth', 'none', 'topFullWidth'],
  ...
  JustifyContent: ['center', 'left', 'right', 'space-between', 'stretch'],
  Orientation: ['horizontal', 'vertical'],
  DefaultType: ['constrained', 'flex', 'grid'],
  VerticalAlignment: ['bottom', 'center', 'space-between', 'stretch', 'top'],
  MarginElement: ['bottom', 'horizontal', 'left', 'right', 'top', 'vertical'],
  TextAlignElement: ['center', 'left', 'right'],
