...
if (!class_exists(Autoloader::class, \false)) {
    class Autoloader
    {
        ...
        public function __construct()
        {
            ...
            $isCustomNamespace = substr($namespaceWithSlash, 0, strlen(self::DEFAULT_NS_PREFIX)) !== self::DEFAULT_NS_PREFIX;
            $libraryPrefix = $isCustomNamespace ? $namespaceWithSlash : '';
            $this->staticMap = array($libraryPrefix . 'PucReadmeParser' => 'vendor/PucReadmeParser.php', $libraryPrefix . 'Parsedown' => 'vendor/Parsedown.php');
            ...
            if ($versionSeparatorPos !== \false) {
                ...
                if ($pointPos !== \false && $pointPos > 1) {
                    ...
                    $this->staticMap[$majorVersionNs . '\PucFactory'] = 'Puc/' . $majorVersionSegment . '/Factory.php';
                }
            }
