...
use BlockstudioVendor\YahnisElsts\PluginUpdateChecker\v5p6\InstalledPackage;
use BlockstudioVendor\YahnisElsts\PluginUpdateChecker\v5p6\UpdateChecker as BaseUpdateChecker;
use BlockstudioVendor\YahnisElsts\PluginUpdateChecker\v5p6\Scheduler;
use BlockstudioVendor\YahnisElsts\PluginUpdateChecker\v5p6\DebugBar;
if (!class_exists(UpdateChecker::class, \false)) {
    ...
    class UpdateChecker extends BaseUpdateChecker
    {
        ...
        public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = '')
        {
            ...
            if ($slugUsedBy) {
                $this->triggerError(sprintf('Plugin slug "%s" is already in use by %s. Slugs must be unique.', $slug, $slugUsedBy), \E_USER_ERROR);
            }
        ...
        {
            list($pluginInfo, $result) = $this->requestMetadata(PluginInfo::class, 'request_info', $queryArgs);
            if ($pluginInfo !== null) {
