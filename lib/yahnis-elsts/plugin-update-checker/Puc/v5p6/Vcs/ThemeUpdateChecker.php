...
if (!class_exists(ThemeUpdateChecker::class, \false)) {
    class ThemeUpdateChecker extends Theme\UpdateChecker implements BaseChecker
    {
        ...
        public function requestUpdate()
        {
            ...
            $update->version = Utils::findNotEmpty(array($remoteHeader['Version'], Utils::get($updateSource, 'version')));
            //The details URL defaults to the Theme URI header or the repository URL.
            $update->details_url = Utils::findNotEmpty(array($remoteHeader['ThemeURI'], $this->package->getHeaderValue('ThemeURI'), $this->metadataUrl));
