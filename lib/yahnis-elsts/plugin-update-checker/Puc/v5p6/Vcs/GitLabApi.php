    ...
    class GitLabApi extends Api
    {
        ...
        public function getLatestRelease()
        {
            ...
            foreach ($releases as $release) {
                if (!is_object($release) || !isset($release->tag_name) || !empty($release->upcoming_release) && $this->shouldSkipPreReleases()) {
                    continue;
                }
                ...
                return new Reference(array('name' => $release->tag_name, 'version' => $versionNumber, 'downloadUrl' => $downloadUrl, 'updated' => $release->released_at, 'apiResponse' => $release));
            }
            return null;
        }
        /**
        ...
        public function getLatestTag()
        {
            ...
            $tag = $versionTags[0];
            return new Reference(array('name' => $tag->name, 'version' => ltrim($tag->name, 'v'), 'downloadUrl' => $this->buildArchiveDownloadUrl($tag->name), 'apiResponse' => $tag));
        }
        /**
