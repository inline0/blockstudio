...
if (!class_exists(PluginUpdateChecker::class, \false)) {
    class PluginUpdateChecker extends Plugin\UpdateChecker implements BaseChecker
    {
        ...
        {
            $icons = $this->getLocalAssetUrls(array('icon.svg' => 'svg', 'icon-256x256.png' => '2x', 'icon-256x256.jpg' => '2x', 'icon-128x128.png' => '1x', 'icon-128x128.jpg' => '1x'));
            if (!empty($icons)) {
        ...
        {
            $banners = $this->getLocalAssetUrls(array('banner-772x250.png' => 'high', 'banner-772x250.jpg' => 'high', 'banner-1544x500.png' => 'low', 'banner-1544x500.jpg' => 'low'));
            if (!empty($banners)) {
