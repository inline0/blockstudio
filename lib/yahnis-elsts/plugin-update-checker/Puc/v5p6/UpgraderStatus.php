...
if (!class_exists(UpgraderStatus::class, \false)) {
    ...
    class UpgraderStatus
    {
        ...
        //This must be either "plugin" or "theme".
        ...
        private function getThingBeingUpgradedBy($upgrader)
        {
            ...
            $skin = $upgrader->skin;
            if (isset($skin->theme_info) && $skin->theme_info instanceof \BlockstudioVendor\WP_Theme) {
                $themeDirectoryName = $skin->theme_info->get_stylesheet();
            } elseif ($skin instanceof \BlockstudioVendor\Plugin_Upgrader_Skin) {
                if (isset($skin->plugin) && is_string($skin->plugin) && $skin->plugin !== '') {
                    $pluginFile = $skin->plugin;
                }
            } elseif ($skin instanceof \BlockstudioVendor\Theme_Upgrader_Skin) {
