...
{
    public function __construct(private readonly SourceLocation $start, private readonly SourceLocation $end, private readonly string $text, private readonly string $context)
    {
