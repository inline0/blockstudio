...
final class SourceFile
{
    ...
    private function isNearCacheLine(int $offset): bool
    {
        ...
        if ($this->cachedLine >= \count($this->lineStarts) - 1 || $offset < $this->lineStarts[$this->cachedLine + 1]) {
            return \true;
        }
        if ($this->cachedLine >= \count($this->lineStarts) - 2 || $offset < $this->lineStarts[$this->cachedLine + 2]) {
            ++$this->cachedLine;
            return \true;
        }
        return \false;
