...
use BlockstudioVendor\ScssPhp\ScssPhp\Visitor\ReplaceExpressionVisitor;
/**
    ...
    public function visitUnaryOperationExpression(UnaryOperationExpression $node): Expression
    {
        switch ($node->getOperator()) {
            ...
            case UnaryOperator::MINUS:
                return new BinaryOperationExpression(BinaryOperator::TIMES, new NumberExpression(-1, $node->getSpan()), $node->getOperand());
