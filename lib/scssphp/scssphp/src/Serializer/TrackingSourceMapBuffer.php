...
use BlockstudioVendor\ScssPhp\ScssPhp\SourceMap\Builder\Entry;
use BlockstudioVendor\ScssPhp\ScssPhp\SourceMap\SingleMapping;
...
use BlockstudioVendor\SourceSpan\SourceLocation;
...
final class TrackingSourceMapBuffer implements SourceMapBuffer
{
    ...
    public function buildSourceMap(?string $prefix): SingleMapping
    {
        ...
        return SingleMapping::fromEntries(array_map(fn(Entry $entry) => new Entry($entry->source, new SimpleSourceLocation(
