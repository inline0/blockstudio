...
class FunctionRegistry
{
    ...
    private const BUILTIN_FUNCTIONS = [
        ...
        'rgb' => ['overloads' => ['$red, $green, $blue, $alpha' => [ColorFunctions::class, 'rgb'], '$red, $green, $blue' => [ColorFunctions::class, 'rgb'], '$color, $alpha' => [ColorFunctions::class, 'rgbTwoArgs'], '$channels' => [ColorFunctions::class, 'rgbOneArgs']]],
        'rgba' => ['overloads' => ['$red, $green, $blue, $alpha' => [ColorFunctions::class, 'rgba'], '$red, $green, $blue' => [ColorFunctions::class, 'rgba'], '$color, $alpha' => [ColorFunctions::class, 'rgbaTwoArgs'], '$channels' => [ColorFunctions::class, 'rgbaOneArgs']]],
        ...
        'hsl' => ['overloads' => ['$hue, $saturation, $lightness, $alpha' => [ColorFunctions::class, 'hsl'], '$hue, $saturation, $lightness' => [ColorFunctions::class, 'hsl'], '$hue, $saturation' => [ColorFunctions::class, 'hslTwoArgs'], '$channels' => [ColorFunctions::class, 'hslOneArgs']]],
        'hsla' => ['overloads' => ['$hue, $saturation, $lightness, $alpha' => [ColorFunctions::class, 'hsla'], '$hue, $saturation, $lightness' => [ColorFunctions::class, 'hsla'], '$hue, $saturation' => [ColorFunctions::class, 'hslaTwoArgs'], '$channels' => [ColorFunctions::class, 'hslaOneArgs']]],
        ...
        'saturate' => ['overloads' => ['$amount' => [ColorFunctions::class, 'saturateCss'], '$color, $amount' => [ColorFunctions::class, 'saturate']]],
        ...
        'alpha' => ['overloads' => ['$color' => [ColorFunctions::class, 'alpha'], '$args...' => [ColorFunctions::class, 'alphaMicrosoft']]],
        ...
        'map-merge' => ['overloads' => ['$map1, $map2' => [MapFunctions::class, 'mergeTwoArgs'], '$map1, $args...' => [MapFunctions::class, 'mergeVariadic']], 'canonical_name' => 'merge'],
    ...
    {
        return isset(self::BUILTIN_FUNCTIONS[$name]) || \in_array($name, self::SPECIAL_META_GLOBAL_FUNCTIONS, \true);
    }
    /**
