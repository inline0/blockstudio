 ...
 */
namespace BlockstudioVendor\ScssPhp\ScssPhp\SourceSpan;
...
final class MultiSpan implements FileSpan
{
     ...
     */
    public function __construct(private readonly FileSpan $primary, private readonly string $primaryLabel, private readonly array $secondarySpans)
    {
    }
