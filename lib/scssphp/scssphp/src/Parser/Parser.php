...
use BlockstudioVendor\ScssPhp\ScssPhp\Exception\MultiSpanSassFormatException;
...
use BlockstudioVendor\ScssPhp\ScssPhp\SourceSpan\LazyFileSpan;
use BlockstudioVendor\ScssPhp\ScssPhp\Util\Character;
use BlockstudioVendor\ScssPhp\ScssPhp\Util\ParserUtil;
use BlockstudioVendor\SourceSpan\FileLocation;
...
class Parser
{
    ...
    protected function escape(bool $identifierStart = \false): string
    {
        ...
        if ($value <= 0x1f || $valueText === "" || $identifierStart && Character::isDigit($valueText)) {
