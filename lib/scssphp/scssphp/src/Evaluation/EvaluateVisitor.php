 ...
 */
namespace BlockstudioVendor\ScssPhp\ScssPhp\Evaluation;

use BlockstudioVendor\League\Uri\Uri;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\AstNode;
...
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Css\CssMediaQuery;
...
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Css\MediaQuerySingletonMergeResult;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Css\ModifiableCssAtRule;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Css\ModifiableCssComment;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Css\ModifiableCssDeclaration;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Css\ModifiableCssImport;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Css\ModifiableCssKeyframeBlock;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Css\ModifiableCssMediaRule;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Css\ModifiableCssNode;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Css\ModifiableCssParentNode;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Css\ModifiableCssStyleRule;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Css\ModifiableCssStylesheet;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Css\ModifiableCssSupportsRule;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\FakeAstNode;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Sass\ArgumentDeclaration;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Sass\ArgumentInvocation;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Sass\AtRootQuery;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Sass\CallableInvocation;
...
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Sass\Expression\BinaryOperator;
...
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Sass\Expression\IsCalculationSafeVisitor;
...
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Sass\Expression\UnaryOperator;
...
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Sass\Import\DynamicImport;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Sass\Import\StaticImport;
...
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Sass\SupportsCondition\SupportsAnything;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Sass\SupportsCondition\SupportsDeclaration;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Sass\SupportsCondition\SupportsFunction;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Sass\SupportsCondition\SupportsInterpolation;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Sass\SupportsCondition\SupportsNegation;
use BlockstudioVendor\ScssPhp\ScssPhp\Ast\Sass\SupportsCondition\SupportsOperation;
...
use BlockstudioVendor\ScssPhp\ScssPhp\Colors;
use BlockstudioVendor\ScssPhp\ScssPhp\Deprecation;
use BlockstudioVendor\ScssPhp\ScssPhp\Exception\MultiSpanSassRuntimeException;
use BlockstudioVendor\ScssPhp\ScssPhp\Exception\SassException;
use BlockstudioVendor\ScssPhp\ScssPhp\Exception\SassRuntimeException;
...
use BlockstudioVendor\ScssPhp\ScssPhp\Exception\SimpleSassFormatException;
use BlockstudioVendor\ScssPhp\ScssPhp\Exception\SimpleSassRuntimeException;
use BlockstudioVendor\ScssPhp\ScssPhp\Extend\ConcreteExtensionStore;
use BlockstudioVendor\ScssPhp\ScssPhp\Extend\Extension;
use BlockstudioVendor\ScssPhp\ScssPhp\Extend\ExtensionStore;
use BlockstudioVendor\ScssPhp\ScssPhp\Function\FunctionRegistry;
use BlockstudioVendor\ScssPhp\ScssPhp\Importer\ImportCache;
use BlockstudioVendor\ScssPhp\ScssPhp\Importer\Importer;
use BlockstudioVendor\ScssPhp\ScssPhp\Logger\LoggerInterface;
use BlockstudioVendor\ScssPhp\ScssPhp\Parser\InterpolationMap;
use BlockstudioVendor\ScssPhp\ScssPhp\Parser\KeyframeSelectorParser;
use BlockstudioVendor\ScssPhp\ScssPhp\SassCallable\BuiltInCallable;
use BlockstudioVendor\ScssPhp\ScssPhp\SassCallable\PlainCssCallable;
use BlockstudioVendor\ScssPhp\ScssPhp\SassCallable\SassCallable;
use BlockstudioVendor\ScssPhp\ScssPhp\SassCallable\UserDefinedCallable;
use BlockstudioVendor\ScssPhp\ScssPhp\SourceSpan\MultiSpan;
use BlockstudioVendor\ScssPhp\ScssPhp\StackTrace\Frame;
use BlockstudioVendor\ScssPhp\ScssPhp\StackTrace\Trace;
use BlockstudioVendor\ScssPhp\ScssPhp\Util;
use BlockstudioVendor\ScssPhp\ScssPhp\Util\AstUtil;
use BlockstudioVendor\ScssPhp\ScssPhp\Util\Character;
...
use BlockstudioVendor\ScssPhp\ScssPhp\Util\LoggerUtil;
use BlockstudioVendor\ScssPhp\ScssPhp\Util\SpanUtil;
use BlockstudioVendor\ScssPhp\ScssPhp\Util\StringUtil;
use BlockstudioVendor\ScssPhp\ScssPhp\Value\CalculationOperation;
use BlockstudioVendor\ScssPhp\ScssPhp\Value\CalculationOperator;
...
use BlockstudioVendor\SourceSpan\SourceFile;
use BlockstudioVendor\SourceSpan\SimpleSourceLocation;
/**
...
class EvaluateVisitor implements StatementVisitor, ExpressionVisitor
{
    ...
    public function __construct(ImportCache $importCache, array $functions, LoggerInterface $logger, bool $quietDeps = \false, bool $sourceMap = \false)
    {
        ...
        $metaFunctions = [BuiltInCallable::function('global-variable-exists', '$name, $module: null', function ($arguments) {
        ...
        }, $sassMetaUri), BuiltInCallable::function('variable-exists', '$name', function ($arguments) {
            $variable = $arguments[0]->assertString('name');
            return SassBoolean::create($this->environment->variableExists(str_replace('_', '-', $variable->getText())));
        }, $sassMetaUri), BuiltInCallable::function('function-exists', '$name, $module: null', function ($arguments) {
            $variable = $arguments[0]->assertString('name');
            $module = $arguments[1]->realNull()?->assertString('module');
            if ($module !== null) {
                // TODO remove this when implementing modules
        ...
        }, $sassMetaUri), BuiltInCallable::function('mixin-exists', '$name, $module: null', function ($arguments) {
            $variable = $arguments[0]->assertString('name');
            $module = $arguments[1]->realNull()?->assertString('module');
            if ($module !== null) {
                // TODO remove this when implementing modules
        ...
        }, $sassMetaUri), BuiltInCallable::function('content-exists', '', function ($arguments) {
        ...
        }, $sassMetaUri), BuiltInCallable::function('get-function', '$name, $css: false, $module: null', function ($arguments) {
        ...
        }, $sassMetaUri), BuiltInCallable::function('get-mixin', '$name, $module: null', function ($arguments) {
            $name = $arguments[0]->assertString('name');
            $module = $arguments[1]->realNull()?->assertString('module');
            \assert($this->callableNode !== null);
            $callable = $this->addExceptionSpan($this->callableNode, function () use ($name, $module) {
        ...
        }, $sassMetaUri), BuiltInCallable::function('call', '$function, $args...', function ($arguments) {
    ...
    public function visitAtRootRule(AtRootRule $node): ?Value
    {
        ...
        if ($unparsedQuery !== null) {
            [$resolved, $map] = $this->performInterpolationWithMap($unparsedQuery, \true);
    ...
    private function scopeForAtRoot(AtRootRule $node, ModifiableCssParentNode $newParent, AtRootQuery $query, array $included): callable
    {
        ...
        if ($query->excludesStyleRules()) {
            ...
            $scope = function (callable $callback) use ($innerScope) {
                $oldAtRootExcludingStyleRule = $this->atRootExcludingStyleRule;
                $this->atRootExcludingStyleRule = \true;
                $innerScope($callback);
                $this->atRootExcludingStyleRule = $oldAtRootExcludingStyleRule;
            };
        }
    ...
    public function visitDeclaration(Declaration $node): ?Value
    {
        ...
        $interleavedRules = [];
        if (ListUtil::last($siblings) !== $this->getParent() && !($this->quietDeps && ($this->inDependency || ($this->currentCallable?->isInDependency() ?? \false)))) {
            $parentOffset = array_search($this->getParent(), $siblings, \true);
...
MESSAGE
, new MultiSpan($node->getSpan(), 'declaration', ['nested rule' => $sibling->getSpan()]), Deprecation::mixedDecls);
                $interleavedRules = [];
            }
        }
        $name = $this->interpolationToValue($node->getName(), \true);
        ...
        if ($expression !== null) {
            ...
            if (!$value->isBlank() || empty($value->asList())) {
                ...
                $this->getParent()->addChild(new ModifiableCssDeclaration($name, new CssValue($value, $expression->getSpan()), $node->getSpan(), $node->isCustomProperty(), $interleavedRules, $interleavedRules === [] ? null : $this->stackTrace($node->getSpan()), $valueSpanForMap));
    ...
    public function visitExtendRule(ExtendRule $node): ?Value
    {
        ...
        foreach ($styleRule->getOriginalSelector()->getComponents() as $complex) {
            ...
            $this->warn("The selector \"{$selectorString}\" is invalid CSS and {$verb} be an extender.\nThis will be an error in Dart Sass 2.0.0.\n\nMore info: https://sass-lang.com/d/bogus-combinators", new MultiSpan(SpanUtil::trimRight($complex->getSpan()), 'invalid selector', ['@extend rule' => $node->getSpan()]), Deprecation::bogusCombinators);
        }
        [$targetText, $targetMap] = $this->performInterpolationWithMap($node->getSelector(), \true);
        $list = SelectorList::parse(StringUtil::trimAscii($targetText, \true), $this->logger, $targetMap, null, \false);
    ...
    public function visitAtRule(AtRule $node): ?Value
    {
        ...
        $value = $node->getValue() !== null ? $this->interpolationToValue($node->getValue(), \true, \true) : null;
        $children = $node->getChildren();
        if ($children === null) {
            $this->getParent()->addChild(new ModifiableCssAtRule($name, $node->getSpan(), \true, $value));
            return null;
        }
        $wasInKeyframes = $this->inKeyFrames;
        $wasInUnknownAtRule = $this->inUnknownAtRule;
        if (Util::unvendor($name->getValue()) === 'keyframes') {
            $this->inKeyFrames = \true;
        } else {
            $this->inUnknownAtRule = \true;
        }
        $this->withParent(new ModifiableCssAtRule($name, $node->getSpan(), \false, $value), function () use ($children, $name) {
            $styleRule = $this->getStyleRule();
    ...
    private function visitDynamicImport(DynamicImport $import): void
    {
        $this->withStackFrame('@import', $import, function () use ($import) {
            $result = $this->loadStylesheet($import->getUrlString(), $import->getSpan(), \true);
    ...
    private function loadStylesheet(string $url, FileSpan $span, bool $forImport = \false): LoadedStylesheet
    {
        try {
            ...
            if ($result !== null) {
                ...
                $this->loadedUrls[$canonicalUrl->toString()] = \true;
    ...
    private function applyMixin(?SassCallable $mixin, ?UserDefinedCallable $contentCallable, ArgumentInvocation $arguments, AstNode $nodeWithSpan, AstNode $nodeWithSpanWithoutContent): void
    {
        ...
        if ($mixin instanceof BuiltInCallable && !$mixin->acceptsContent() && $contentCallable !== null) {
            ...
            throw new MultiSpanSassRuntimeException("Mixin doesn't accept a content block.", $nodeWithSpanWithoutContent->getSpan(), 'invocation', ['declaration' => $overload->getSpanWithName()], $this->stackTrace($nodeWithSpanWithoutContent->getSpan()));
        }
        if ($mixin instanceof BuiltInCallable) {
            ...
            if ($contentCallable !== null && !$declaration->hasContent()) {
                throw new MultiSpanSassRuntimeException("Mixin doesn't accept a content block.", $nodeWithSpanWithoutContent->getSpan(), 'invocation', ['declaration' => $mixin->getDeclaration()->getArguments()->getSpanWithName()], $this->stackTrace($nodeWithSpanWithoutContent->getSpan()));
            }
    ...
    public function visitMediaRule(MediaRule $node): ?Value
    {
        ...
        $this->withParent(new ModifiableCssMediaRule($mergedQueries ?? $queries, $node->getSpan()), function () use ($mergedQueries, $mergedSources, $queries, $node) {
            ...
            if ($mergedSources !== [] && $node instanceof CssMediaRule) {
                return IterableUtil::every($node->getQueries(), function (CssMediaQuery $query) use ($mergedSources) {
                    return \in_array($query, $mergedSources, \true);
                });
            }
            return \false;
        }, $node->hasDeclarations());
    ...
    {
        [$resolved, $map] = $this->performInterpolationWithMap($interpolation, \true);
    ...
    public function visitStyleRule(StyleRule $node): ?Value
    {
        ...
        [$selectorText, $selectorMap] = $this->performInterpolationWithMap($node->getSelector(), \true);
        if ($this->inKeyFrames) {
            ...
            $this->withParent($rule, function () use ($node) {
                foreach ($node->getChildren() as $child) {
                    $child->accept($this);
                }
            }, function ($node) {
        ...
        if ($nest) {
            ...
            $parsedSelector = $parsedSelector->nestWithin($this->styleRuleIgnoringAtRoot?->getOriginalSelector(), !$this->atRootExcludingStyleRule, $this->getStylesheet()->isPlainCss());
        }
        ...
        $oldAtRootExcludingStyleRule = $this->atRootExcludingStyleRule;
        $this->atRootExcludingStyleRule = \false;
        $this->withParent($rule, function () use ($rule, $node) {
            $this->withStyleRule($rule, function () use ($node) {
                foreach ($node->getChildren() as $child) {
                    $child->accept($this);
                }
            });
        }, $nest ? fn($node) => $node instanceof CssStyleRule : null, $node->hasDeclarations());
        $this->atRootExcludingStyleRule = $oldAtRootExcludingStyleRule;
        ...
        if (!$rule->isInvisibleOtherThanBogusCombinators()) {
            foreach ($rule->getSelector()->getComponents() as $complex) {
                ...
                if ($complex->isUseless()) {
                    ...
                    $this->warn("The selector \"{$selectorString}\" is only valid for nesting and shouldn't\nhave children other than style rules.{$omittedMessage}\nThis will be an error in Dart Sass 2.0.0.\n\nMore info: https://sass-lang.com/d/bogus-combinators", new MultiSpan(SpanUtil::trimRight($complex->getSpan()), 'invalid selector', ['this is not a style rule' . $suffix => $rule->getChildren()[0]->getSpan()]), Deprecation::bogusCombinators);
                }
            }
        }
    }
    public function visitSupportsRule(SupportsRule $node): ?Value
    {
        ...
        $this->withParent(new ModifiableCssSupportsRule($condition, $node->getSpan()), function () use ($node) {
            $styleRule = $this->getStyleRule();
            if ($styleRule !== null) {
    ...
    private function withSupportsDeclaration(callable $callback)
    {
        ...
        $this->inSupportsDeclaration = \true;
        try {
            return $callback();
        } finally {
    ...
    public function visitVariableDeclaration(VariableDeclaration $node): ?Value
    {
        ...
        if ($node->isGlobal() && !$this->environment->globalVariableExists($node->getName())) {
            $this->warn($this->environment->atRoot() ? "As of Dart Sass 2.0.0, !global assignments won't be able to declare new variables.\n\nSince this assignment is at the root of the stylesheet, the !global flag is\nunnecessary and can safely be removed." : "As of Dart Sass 2.0.0, !global assignments won't be able to declare new variables.\n\nRecommendation: add `{$node->getOriginalName()}: null` at the stylesheet root.", $node->getSpan(), Deprecation::newGlobal);
        }
...
WARNING;
    ...
    private function operandAllowsSlash(Expression $node): bool
    {
        ...
        return \in_array(strtolower($node->getName()), ['calc', 'clamp', 'hypot', 'sin', 'cos', 'tan', 'asin', 'acos', 'atan', 'sqrt', 'exp', 'sign', 'mod', 'rem', 'atan2', 'pow', 'log'], \true) && $this->environment->getFunction($node->getName()) === null;
    }
    ...
    public function visitMapExpression(MapExpression $node): Value
    {
        ...
        foreach ($node->getPairs() as $pair) {
            ...
            if ($oldValue !== null) {
                ...
                throw new MultiSpanSassRuntimeException('Duplicate key.', $pair[0]->getSpan(), 'second key', $oldValueSpan !== null ? ['first key' => $oldValueSpan] : [], $this->stackTrace($pair[0]->getSpan()));
            }
    ...
    public function visitFunctionExpression(FunctionExpression $node): Value
    {
        ...
        if ($function === null) {
            ...
            switch (strtolower($node->getName())) {
                ...
                case 'round':
                case 'abs':
                    if ($node->getArguments()->getNamed() === [] && $node->getArguments()->getRest() === null && IterableUtil::every($node->getArguments()->getPositional(), function (Expression $argument) {
                        return $argument->accept(new IsCalculationSafeVisitor());
                    })) {
                        return $this->visitCalculation($node, \true);
                    }
                    break;
                case 'calc':
                case 'clamp':
    ...
    private function checkCalculationArguments(FunctionExpression $node): void
    {
        $check = function (?int $maxArgs = null) use ($node) {
            ...
            if ($maxArgs !== null && \count($node->getArguments()->getPositional()) > $maxArgs) {
                throw $this->exception(sprintf('Only %d %s allowed, but %d %s passed.', $maxArgs, StringUtil::pluralize('argument', $maxArgs), \count($node->getArguments()->getPositional()), StringUtil::pluralize('was', \count($node->getArguments()->getPositional()), 'were')), $node->getSpan());
            }
        };
        switch (strtolower($node->getName())) {
            case 'calc':
    ...
    private function verifyCompatibleNumbers(array $args, array $nodesWithSpans): void
    {
        ...
        for ($i = 0; $i < \count($args); $i++) {
            ...
            for ($j = $i + 1; $j < \count($args); $j++) {
                ...
                throw new MultiSpanSassRuntimeException("{$number1} and {$number2} are incompatible.", $nodesWithSpans[$i]->getSpan(), (string) $number1, [(string) $number2 => $nodesWithSpans[$j]->getSpan()], $this->stackTrace($nodesWithSpans[$i]->getSpan()));
            }
        }
    }
    /**
    ...
    private function visitCalculationExpression(Expression $node, bool $inLegacySassFunction): object
    {
        if ($node instanceof ParenthesizedExpression) {
            ...
            return $result instanceof SassString ? new SassString('(' . $result->getText() . ')', \false) : $result;
        }
        ...
        if ($node instanceof BinaryOperationExpression) {
            ...
            return $this->addExceptionSpan($node, function () use ($node, $inLegacySassFunction) {
                return SassCalculation::operateInternal($this->binaryOperatorToCalculationOperator($node->getOperator(), $node), $this->visitCalculationExpression($node->getLeft(), $inLegacySassFunction), $this->visitCalculationExpression($node->getRight(), $inLegacySassFunction), $inLegacySassFunction, !$this->inSupportsDeclaration);
            });
        }
    ...
    private function checkAdjacentCalculationValues(array $elements, ListExpression $node): void
    {
        ...
        for ($i = 1; $i < \count($elements); $i++) {
            ...
            if ($currentNode instanceof UnaryOperationExpression && ($currentNode->getOperator() === UnaryOperator::MINUS || $currentNode->getOperator() === UnaryOperator::PLUS) || $currentNode instanceof NumberExpression && $currentNode->getValue() < 0) {
        ...
        $result = $this->withStackFrame($name, $nodeWithSpan, function () use ($callable, $evaluated, $nodeWithSpan, $run) {
            ...
            return $this->withEnvironment($callable->getEnvironment()->closure(), function () use ($callable, $evaluated, $nodeWithSpan, $run) {
                return $this->environment->scope(function () use ($callable, $evaluated, $nodeWithSpan, $run) {
                    ...
                    $message = sprintf('No argument%s named $%s%s.', $unknownNames ? 's' : '', $unknownNames ? implode(', $', $unknownNames) . ' or $' : '', $lastName);
                    throw new MultiSpanSassRuntimeException($message, $nodeWithSpan->getSpan(), 'invocation', ['declaration' => $callable->getDeclaration()->getArguments()->getSpanWithName()], $this->stackTrace($nodeWithSpan->getSpan()));
                });
            });
        });
    ...
    private function runFunctionCallable(ArgumentInvocation $arguments, ?SassCallable $callable, AstNode $nodeWithSpan): Value
    {
        ...
        if ($callable instanceof PlainCssCallable) {
            ...
            try {
                ...
                throw new MultiSpanSassRuntimeException($e->getOriginalMessage(), $e->getSpan(), 'value', ['unknown function treated as plain CSS' => $nodeWithSpan->getSpan()], $e->getSassTrace());
            }
            $buffer .= ')';
    ...
    private function runBuiltInCallable(ArgumentInvocation $arguments, BuiltInCallable $callable, AstNode $nodeWithSpan): Value
    {
        ...
        $lastName = array_pop($unknownNames);
        $message = sprintf('No argument%s named $%s%s.', $unknownNames ? 's' : '', $unknownNames ? implode(', $', $unknownNames) . ' or $' : '', $lastName);
        throw new MultiSpanSassRuntimeException($message, $nodeWithSpan->getSpan(), 'invocation', ['declaration' => $overload->getSpanWithName()], $this->stackTrace($nodeWithSpan->getSpan()));
    }
    ...
    private function interpolationToValue(Interpolation $interpolation, bool $warnForColor = \false, bool $trim = \false): CssValue
    {
        ...
        return new CssValue($trim ? StringUtil::trimAscii($result, \true) : $result, $interpolation->getSpan());
    }
    /**
    ...
    {
        $tuple = $this->performInterpolationHelper($interpolation, \true, $warnForColor);
        \assert($tuple[1] !== null);
        return $tuple;
    }
    /**
    ...
    private function performInterpolationHelper(Interpolation $interpolation, bool $sourceMap, bool $warnForColor = \false): array
    {
        ...
        foreach ($interpolation->getContents() as $value) {
            ...
            if ($warnForColor && $result instanceof SassColor && null !== $colorName = Colors::RGBaToColorName($result->getRed(), $result->getGreen(), $result->getBlue(), $result->getAlpha())) {
                $alternative = new BinaryOperationExpression(BinaryOperator::PLUS, new StringExpression(new Interpolation([''], $interpolation->getSpan()), \true), $expression);
     ...
     */
    private function evaluateToCss(Expression $expression, bool $quote = \true): string
    {
     ...
     * real work to manufacture a source span.
     */
    private function serialize(Value $value, AstNode $nodeWithSpan, bool $quote = \true): string
    {
     ...
     */
    private function withParent(ModifiableCssParentNode $node, callable $callback, ?callable $through = null, bool $scopeWhen = \true)
    {
...
WARNING;
    ...
    public function warn(string $message, FileSpan $span, ?Deprecation $deprecation = null): void
    {
        ...
        $spanString = ($span->getSourceUrl() ?? '') . "\x00" . $span->getStart()->getOffset() . "\x00" . $span->getEnd()->getOffset();
        if (isset($this->warningsEmitted[$message][$spanString])) {
            return;
        }
        $this->warningsEmitted[$message][$spanString] = \true;
     ...
     * @param-immediately-invoked-callable $callback
     */
    private function addExceptionSpan(AstNode $nodeWithSpan, callable $callback, bool $addStackFrame = \true)
    {
        try {
            return $callback();
        } catch (SassScriptException $e) {
