...
use BlockstudioVendor\ScssPhp\ScssPhp\Compiler\LegacyValueVisitor;
use BlockstudioVendor\ScssPhp\ScssPhp\Evaluation\EvaluateVisitor;
...
use BlockstudioVendor\ScssPhp\ScssPhp\Importer\FilesystemImporter;
use BlockstudioVendor\ScssPhp\ScssPhp\Importer\ImportCache;
use BlockstudioVendor\ScssPhp\ScssPhp\Importer\Importer;
use BlockstudioVendor\ScssPhp\ScssPhp\Importer\LegacyCallbackImporter;
use BlockstudioVendor\ScssPhp\ScssPhp\Importer\NoOpImporter;
...
use BlockstudioVendor\ScssPhp\ScssPhp\Logger\StreamLogger;
use BlockstudioVendor\ScssPhp\ScssPhp\Node\Number;
use BlockstudioVendor\ScssPhp\ScssPhp\SassCallable\BuiltInCallable;
use BlockstudioVendor\ScssPhp\ScssPhp\Serializer\Serializer;
...
final class Compiler
{
    ...
    {
        $this->logger = new StreamLogger(fopen('php://stderr', 'w'), \true);
    }
    /**
