 ...
 */
namespace BlockstudioVendor\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'BlockstudioVendor\mes\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'BlockstudioVendor\Mes\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'BlockstudioVendor\ma\1'],
        ['/^Mes(dame|demoiselle)s$/', 'BlockstudioVendor\Ma\1'],
        ['/^mes(sieur|seigneur)s$/', 'BlockstudioVendor\mon\1'],
        ['/^Mes(sieur|seigneur)s$/', 'BlockstudioVendor\Mon\1'],
        // Default rule
        ['/s$/i', ''],
    ];
