...
class Build {
	...
	/**
	 * Filter not key (legacy method name).
	 *
	 * @deprecated Use filter_not_key() instead.
	 *
	 * @param array  $array The array to filter (passed by reference).
	 * @param string $key   The key to filter by.
	 * @param mixed  $val   The value to filter by.
	...
	public static function filterNotKey( &$array, $key, $val ) {
		self::filter_not_key( $array, $key, $val );
	}

	/**
	 * Build attributes (legacy method name).
	 *
	 * @deprecated Use build_attributes() instead.
	 *
	 * @param array  $attrs         The attributes to build.
	 * @param array  $attributes    The attributes array (passed by reference).
	 * @param string $id            The ID prefix.
	...
	/**
	 * Filter attributes (legacy method name).
	 *
	 * @deprecated Use filter_attributes() instead.
	 *
	 * @param array $block      The block data.
	 * @param array $attrs      The attributes to filter.
	 * @param array $attributes The filtered attributes (passed by reference).
	...
	public static function filterAttributes( $block, $attrs, &$attributes ) {
		self::filter_attributes( $block, $attrs, $attributes );
	}

	/**
	 * Build attribute IDs (legacy method name).
	 *
	 * @deprecated Use build_attribute_ids() instead.
	 *
	 * @param array $attributes The attributes (passed by reference).
	 *
	 * @return void
	...
	public static function buildAttributeIds( &$attributes ) {
		self::build_attribute_ids( $attributes );
	}

	/**
	 * Merge attributes (legacy method name).
	 *
	 * @deprecated Use merge_attributes() instead.
	 *
	 * @param array $original_attributes The original attributes (passed by reference).
	 * @param array $override_attributes The override attributes.
	 *
	...
	public static function mergeAttributes(
		...
		self::merge_attributes( $original_attributes, $override_attributes );
	}

	/**
	 * Get instance name (legacy method name).
	 *
	 * @deprecated Use get_instance_name() instead.
	 *
	 * @param string $path The path.
	 *
	 * @return string The instance name.
	...
	public static function getInstanceName( $path ): string {
		return self::get_instance_name( $path );
	}

	/**
	 * Get build dir (legacy method name).
	 *
	 * @deprecated Use get_build_dir() instead.
	 *
	 * @param string $path   The path.
	 * @param string $filter The filter.
	 *
	...
	public static function getBuildDir(
		...
		return self::get_build_dir( $path, $filter );
	}

	/**
	 * Path to array (legacy method name).
	 *
	 * @deprecated Use path_to_array() instead.
	 *
	 * @param array  $array     The array (passed by reference).
	 * @param string $path      The path.
	 * @param mixed  $value     The value.
	...
	public static function pathToArray(
		...
		return self::path_to_array( $array, $path, $value, $delimiter );
	}

	/**
	 * Recursive sort (legacy method name).
	 *
	 * @deprecated Use recursive_sort() instead.
	 *
	 * @param array $arr The array (passed by reference).
	 *
	 * @return void
	...
	public static function recursiveSort( &$arr ) {
		self::recursive_sort( $arr );
	}

	/**
	 * Data sorted (legacy method name).
	 *
	 * @deprecated Use data_sorted() instead.
	 *
	 * @return array The sorted data.
	 * @throws SassException When SCSS compilation fails.
	 */
	...
	/**
	 * Assets admin (legacy method name).
	 *
	 * @deprecated Use assets_admin() instead.
	 *
	 * @return array The admin assets.
	 */
	...
	/**
	 * Assets block editor (legacy method name).
	 *
	 * @deprecated Use assets_block_editor() instead.
	 *
	 * @return array The block editor assets.
	 */
	...
	/**
	 * Assets global (legacy method name).
	 *
	 * @deprecated Use assets_global() instead.
	 *
	 * @return array The global assets.
	 */
	...
	/**
	 * Is Tailwind active (legacy method name).
	 *
	 * @deprecated Use is_tailwind_active() instead.
	 *
	 * @return bool Whether Tailwind is active.
	 */
