...
order: 5
section: "Guides"
meta_title: "Block Context and Communication"
meta_description: "Pass data between parent and child blocks. Build section wrappers, card grids, pricing tables, and other component patterns where blocks need to talk to each other."
---
...
- [InnerBlocks](/docs/blocks/react-components/innerblocks): the `<InnerBlocks />` component, `allowedBlocks`, templates, and the frontend wrapper filter.
