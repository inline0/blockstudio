        ...
        <div className="col-span-2 flex flex-col gap-3 rounded-xl border border-[var(--color-plus)]/8 bg-[var(--color-plus-graphic)]/3 p-4">
          ...
          <div className="flex flex-col gap-1.5 font-mono text-xs leading-relaxed">
            ...
            <span className="pl-4 text-fd-muted-foreground/60">
              &quot;name&quot;:{' '}
              <span className="text-[var(--color-plus)]">
                &quot;starter/hero&quot;
              </span>
              ,
            </span>
            <span className="pl-4 text-fd-muted-foreground/60">
              &quot;title&quot;:{' '}
              <span className="text-[var(--color-plus)]">&quot;Hero&quot;</span>
              ,
            </span>
            <span className="pl-4 text-fd-muted-foreground/60">
              &quot;blockstudio&quot;: {'{ ... }'}
        ...
        <div className="flex flex-col justify-center gap-6">
          ...
          <ul className="flex flex-col gap-2.5">
            {includes.map((item) => (
              ...
              >
                <Check className="size-3.5 shrink-0 text-[var(--color-plus)]" />
                {item}
              </li>
            ))}
          </ul>
          ...
          <a
            ...
            className="mt-2 inline-flex w-fit items-center rounded-full bg-[var(--color-plus-button)] px-5 py-2.5 text-sm font-semibold text-black transition-colors hover:bg-[var(--color-plus-button)]/80"
          >
            Get Plus &rarr;
          </a>
        </div>
