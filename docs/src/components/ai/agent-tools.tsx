    ...
    >
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
        {agents.map((agent) => (
          <div
            key={agent.name}
            className="flex flex-col items-center gap-3 rounded-xl border bg-fd-secondary/30 p-5 transition-colors hover:bg-fd-secondary/50"
          >
            <svg
              viewBox={agent.viewBox}
              className={cn(
                'size-6',
                'darkColor' in agent && 'dark:!fill-white',
              )}
