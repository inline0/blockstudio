...
const socials = [
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/groups/blockstudio',
    icon: (
  ...
  {
    label: 'X',
    href: 'https://x.com/useblockstudio',
    icon: (
      <svg viewBox="0 0 24 24" className="size-4 fill-current">
  ...
  {
    label: 'YouTube',
    href: 'https://www.youtube.com/@useblockstudio',
    icon: (
      <svg viewBox="0 0 24 24" className="size-4 fill-current">
  ...
  {
    label: 'GitHub',
    href: 'https://github.com/inline0/blockstudio',
    icon: (
      <svg viewBox="0 0 24 24" className="size-4 fill-current">
