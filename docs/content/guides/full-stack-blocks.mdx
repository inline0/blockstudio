...
The examples below use the array syntax because it's the most compact, but in
7.2 all three PHP surfaces also have PHP-native alternatives:

- `db.php` can use `Blockstudio\\Api\\Db\\Schema` and `Blockstudio\\Api\\Db\\Field`
