...
inside the editor. See [useBlockProps](/docs/components/useblockprops) for more information.
...
The [Select](/docs/attributes/field-types#select) and
[Radio](/docs/attributes/field-types#radio) field types support dynamically
