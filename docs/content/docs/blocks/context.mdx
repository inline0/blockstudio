...
See [InnerBlocks Context](/docs/blocks/components/innerblocks#context) for more details.

<GuideBanner
  href="/guides/block-context"
  title="Block Context and Communication"
  description="Practical patterns: card grids, pricing tables, and section wrappers where blocks need to share data."
/>
