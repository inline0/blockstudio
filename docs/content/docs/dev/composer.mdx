...
Blockstudio bootstraps automatically through Composer's autoloader. Asset URLs resolve to the correct theme directory. Blocks defined in your theme's `blockstudio/` folder work exactly as they would with a plugin install.
