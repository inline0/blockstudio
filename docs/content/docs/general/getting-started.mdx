...
1. Download the latest release zip from [GitHub Releases](https://github.com/inline0/blockstudio/releases)
2. Upload to your WordPress plugins directory
3. Activate the plugin

Manual installations receive automatic update notifications in the WordPress dashboard via the built-in GitHub updater.
