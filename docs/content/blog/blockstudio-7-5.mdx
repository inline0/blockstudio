...
description: Custom field types and file-backed Site Editor templates.
date: 2026-06-30
author: Dennis
---

Blockstudio 7.5 starts with two pieces that make Blockstudio's file-first
workflow more complete: custom field types and file-backed Site Editor
templates.
