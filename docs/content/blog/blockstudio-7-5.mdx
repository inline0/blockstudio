...
description: Custom field types, file-backed Site Editor templates, block islands, and Storh database storage.
date: 2026-06-30
author: Dennis
---

Blockstudio 7.5 starts with four pieces that make Blockstudio's file-first
workflow more complete: custom field types, file-backed Site Editor templates,
block islands, and Storh database storage.
