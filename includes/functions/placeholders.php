...
function blockstudio_placeholder_dark( string $variant = 'default' ): string {
	$svgs = array(
		'default'   => <<<'SVG'
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice" style="display:block;width:100%;height:100%;color:var(--color-accent)"><rect x="28" y="28" width="1144" height="744" rx="6" fill="rgba(255,255,255,0.02)"/>
...
<path d="M12 0 H1188 Q1200 0 1200 12 V788 Q1200 800 1188 800 H12 Q0 800 0 788 V12 Q0 0 12 0 Z M34 28 H1166 Q1172 28 1172 34 V766 Q1172 772 1166 772 H34 Q28 772 28 766 V34 Q28 28 34 28 Z" fill="rgba(255,255,255,0.07)" fill-rule="evenodd"/></svg>
SVG
		,
		'dashboard' => <<<'SVG'
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice" style="display:block;width:100%;height:100%;color:var(--color-accent)"><rect x="12" y="12" width="1176" height="776" rx="8" fill="rgba(255,255,255,0.02)"/><rect width="1200" height="48" fill="rgba(255,255,255,0.04)"/>
...
<path d="M12 0 H1188 Q1200 0 1200 12 V788 Q1200 800 1188 800 H12 Q0 800 0 788 V12 Q0 0 12 0 Z M20 12 H1180 Q1188 12 1188 20 V780 Q1188 788 1180 788 H20 Q12 788 12 780 V20 Q12 12 20 12 Z" fill="rgba(255,255,255,0.07)" fill-rule="evenodd"/></svg>
SVG
		,
		'chart'     => <<<'SVG'
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice" style="display:block;width:100%;height:100%;color:var(--color-accent)"><rect x="12" y="12" width="1176" height="776" rx="8" fill="rgba(255,255,255,0.02)"/><rect width="1200" height="48" fill="rgba(255,255,255,0.04)"/>
...
SVG
		,
		'user'      => <<<'SVG'
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 1000" preserveAspectRatio="xMidYMid slice" style="display:block;width:100%;height:100%;color:var(--color-accent)"><rect x="28" y="28" width="744" height="944" rx="6" fill="rgba(255,255,255,0.02)"/>
...
<path d="M12 0 H788 Q800 0 800 12 V988 Q800 1000 788 1000 H12 Q0 1000 0 988 V12 Q0 0 12 0 Z M34 28 H766 Q772 28 772 34 V966 Q772 972 766 972 H34 Q28 972 28 966 V34 Q28 28 34 28 Z" fill="rgba(255,255,255,0.07)" fill-rule="evenodd"/></svg>
SVG
		,
		'space'     => <<<'SVG'
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice" style="display:block;width:100%;height:100%;color:var(--color-accent)"><rect x="40" y="40" width="1120" height="720" rx="6" fill="rgba(255,255,255,0.02)"/>
...
<path d="M12 0 H1188 Q1200 0 1200 12 V788 Q1200 800 1188 800 H12 Q0 800 0 788 V12 Q0 0 12 0 Z M46 40 H1154 Q1160 40 1160 46 V754 Q1160 760 1154 760 H46 Q40 760 40 754 V46 Q40 40 46 40 Z" fill="rgba(255,255,255,0.07)" fill-rule="evenodd"/></svg>
SVG
		,
		'project'   => <<<'SVG'
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice" style="display:block;width:100%;height:100%;color:var(--color-accent)"><rect x="40" y="40" width="1120" height="720" rx="6" fill="rgba(255,255,255,0.02)"/>
...
function blockstudio_placeholder_light( string $variant = 'default' ): string {
	$svgs = array(
		'default'   => <<<'SVG'
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice" style="display:block;width:100%;height:100%;color:var(--color-accent)"><rect x="28" y="28" width="1144" height="744" rx="6" fill="rgba(0,0,0,0.02)"/>
...
<path d="M12 0 H1188 Q1200 0 1200 12 V788 Q1200 800 1188 800 H12 Q0 800 0 788 V12 Q0 0 12 0 Z M34 28 H1166 Q1172 28 1172 34 V766 Q1172 772 1166 772 H34 Q28 772 28 766 V34 Q28 28 34 28 Z" fill="rgba(0,0,0,0.07)" fill-rule="evenodd"/></svg>
SVG
		,
		'dashboard' => <<<'SVG'
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice" style="display:block;width:100%;height:100%;color:var(--color-accent)"><rect x="12" y="12" width="1176" height="776" rx="8" fill="rgba(0,0,0,0.02)"/><rect width="1200" height="48" fill="rgba(0,0,0,0.04)"/>
...
<path d="M12 0 H1188 Q1200 0 1200 12 V788 Q1200 800 1188 800 H12 Q0 800 0 788 V12 Q0 0 12 0 Z M20 12 H1180 Q1188 12 1188 20 V780 Q1188 788 1180 788 H20 Q12 788 12 780 V20 Q12 12 20 12 Z" fill="rgba(0,0,0,0.07)" fill-rule="evenodd"/></svg>
SVG
		,
		'chart'     => <<<'SVG'
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice" style="display:block;width:100%;height:100%;color:var(--color-accent)"><rect x="12" y="12" width="1176" height="776" rx="8" fill="rgba(0,0,0,0.02)"/><rect width="1200" height="48" fill="rgba(0,0,0,0.04)"/>
...
SVG
		,
		'user'      => <<<'SVG'
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 1000" preserveAspectRatio="xMidYMid slice" style="display:block;width:100%;height:100%;color:var(--color-accent)"><rect x="28" y="28" width="744" height="944" rx="6" fill="rgba(0,0,0,0.02)"/>
...
<path d="M12 0 H788 Q800 0 800 12 V988 Q800 1000 788 1000 H12 Q0 1000 0 988 V12 Q0 0 12 0 Z M34 28 H766 Q772 28 772 34 V966 Q772 972 766 972 H34 Q28 972 28 966 V34 Q28 28 34 28 Z" fill="rgba(0,0,0,0.07)" fill-rule="evenodd"/></svg>
SVG
		,
		'space'     => <<<'SVG'
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice" style="display:block;width:100%;height:100%;color:var(--color-accent)"><rect x="40" y="40" width="1120" height="720" rx="6" fill="rgba(0,0,0,0.02)"/>
...
<path d="M12 0 H1188 Q1200 0 1200 12 V788 Q1200 800 1188 800 H12 Q0 800 0 788 V12 Q0 0 12 0 Z M46 40 H1154 Q1160 40 1160 46 V754 Q1160 760 1154 760 H46 Q40 760 40 754 V46 Q40 40 46 40 Z" fill="rgba(0,0,0,0.07)" fill-rule="evenodd"/></svg>
SVG
		,
		'project'   => <<<'SVG'
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice" style="display:block;width:100%;height:100%;color:var(--color-accent)"><rect x="40" y="40" width="1120" height="720" rx="6" fill="rgba(0,0,0,0.02)"/>
