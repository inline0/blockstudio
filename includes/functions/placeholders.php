...
SVG
		,
		'dashboard' => <<<'SVG'
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice" style="display:block;width:100%;height:100%;color:var(--color-accent)"><rect width="1200" height="800" fill="rgba(255,255,255,0.03)"/><rect width="1200" height="48" fill="rgba(255,255,255,0.04)"/>
...
SVG
		,
		'dashboard' => <<<'SVG'
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice" style="display:block;width:100%;height:100%;color:var(--color-accent)"><rect width="1200" height="800" fill="rgba(0,0,0,0.03)"/><rect width="1200" height="48" fill="rgba(0,0,0,0.04)"/>
...
<rect x="24" y="236" width="80" height="6" rx="3" fill="rgba(0,0,0,0.04)"/>
<rect x="24" y="260" width="150" height="8" rx="4" fill="rgba(0,0,0,0.06)"/>
<rect x="24" y="288" width="120" height="8" rx="4" fill="rgba(0,0,0,0.06)"/>
...
<rect x="756" y="108" width="120" height="10" rx="5" fill="rgba(0,0,0,0.1)"/>
<rect x="756" y="136" width="340" height="6" rx="3" fill="rgba(0,0,0,0.04)"/>
<rect x="756" y="156" width="300" height="6" rx="3" fill="rgba(0,0,0,0.04)"/>
<rect x="756" y="192" width="340" height="60" rx="8" fill="rgba(0,0,0,0.02)" stroke="rgba(0,0,0,0.06)"/>
...
<rect x="280" y="384" width="460" height="6" rx="3" fill="rgba(0,0,0,0.04)"/>
...
<rect x="280" y="564" width="80" height="8" rx="4" fill="rgba(0,0,0,0.08)"/>
<rect x="280" y="588" width="200" height="6" rx="3" fill="rgba(0,0,0,0.04)"/>
<rect x="280" y="608" width="180" height="6" rx="3" fill="rgba(0,0,0,0.04)"/>
<rect x="592" y="564" width="80" height="8" rx="4" fill="rgba(0,0,0,0.08)"/>
<rect x="592" y="588" width="200" height="6" rx="3" fill="rgba(0,0,0,0.04)"/>
<rect x="592" y="608" width="180" height="6" rx="3" fill="rgba(0,0,0,0.04)"/>
<rect x="904" y="564" width="80" height="8" rx="4" fill="rgba(0,0,0,0.08)"/>
<rect x="904" y="588" width="200" height="6" rx="3" fill="rgba(0,0,0,0.04)"/>
<rect x="904" y="608" width="180" height="6" rx="3" fill="rgba(0,0,0,0.04)"/>
</svg>
SVG
		,
		'chart'     => <<<'SVG'
...
<rect x="68" y="104" width="60" height="8" rx="4" fill="rgba(0,0,0,0.06)"/>
<rect x="68" y="128" width="100" height="14" rx="4" fill="rgba(0,0,0,0.1)"/>
<rect x="68" y="156" width="40" height="6" rx="3" fill="rgba(0,0,0,0.04)"/>
<rect x="348" y="104" width="60" height="8" rx="4" fill="rgba(0,0,0,0.06)"/>
<rect x="348" y="128" width="80" height="14" rx="4" fill="rgba(0,0,0,0.1)"/>
<rect x="348" y="156" width="40" height="6" rx="3" fill="rgba(0,0,0,0.04)"/>
<rect x="628" y="104" width="60" height="8" rx="4" fill="currentColor" fill-opacity="0.25"/>
<rect x="628" y="128" width="90" height="14" rx="4" fill="currentColor" fill-opacity="0.4"/>
<rect x="628" y="156" width="40" height="6" rx="3" fill="currentColor" fill-opacity="0.15"/>
<rect x="908" y="104" width="60" height="8" rx="4" fill="rgba(0,0,0,0.06)"/>
<rect x="908" y="128" width="120" height="14" rx="4" fill="rgba(0,0,0,0.1)"/>
<rect x="908" y="156" width="40" height="6" rx="3" fill="rgba(0,0,0,0.04)"/>
<rect x="40" y="212" width="1120" height="548" rx="12" fill="white" stroke="rgba(0,0,0,0.08)"/>
<line x1="120" y1="260" x2="120" y2="700" stroke="rgba(0,0,0,0.04)"/>
<line x1="120" y1="700" x2="1100" y2="700" stroke="rgba(0,0,0,0.06)"/>
<line x1="120" y1="360" x2="1100" y2="360" stroke="rgba(0,0,0,0.04)" stroke-dasharray="4 4"/>
...
<rect x="68" y="276" width="30" height="6" rx="3" fill="rgba(0,0,0,0.04)"/>
<rect x="68" y="356" width="30" height="6" rx="3" fill="rgba(0,0,0,0.04)"/>
<rect x="68" y="436" width="30" height="6" rx="3" fill="rgba(0,0,0,0.04)"/>
<rect x="68" y="516" width="30" height="6" rx="3" fill="rgba(0,0,0,0.04)"/>
<rect x="68" y="616" width="30" height="6" rx="3" fill="rgba(0,0,0,0.04)"/>
<path d="M120 600 C220 580 280 540 400 480 C520 420 580 400 700 360 C820 320 880 300 1000 280 L1100 260" fill="none" stroke="currentColor" stroke-opacity="0.5" stroke-width="2.5"/>
...
<path d="M120 650 C260 640 380 620 500 590 C620 560 740 540 860 520 C940 508 1020 500 1100 490" fill="none" stroke="rgba(0,0,0,0.08)" stroke-width="2"/>
<circle cx="400" cy="480" r="4" fill="currentColor"/>
<circle cx="700" cy="360" r="4" fill="currentColor"/>
<circle cx="1000" cy="280" r="4" fill="currentColor"/>
<circle cx="500" cy="590" r="3" fill="rgba(0,0,0,0.12)"/>
<circle cx="860" cy="520" r="3" fill="rgba(0,0,0,0.12)"/>
</svg>
SVG
		,
		'code'      => <<<'SVG'
...
<line x1="56" y1="48" x2="56" y2="800" stroke="rgba(0,0,0,0.04)"/>
<rect x="1140" y="48" width="60" height="752" fill="rgba(0,0,0,0.02)"/>
<line x1="1140" y1="48" x2="1140" y2="800" stroke="rgba(0,0,0,0.04)"/>
<rect x="1152" y="80" width="36" height="3" rx="1.5" fill="currentColor" fill-opacity="0.25"/>
<rect x="1152" y="100" width="36" height="2" rx="1" fill="rgba(0,0,0,0.06)"/>
<rect x="1152" y="116" width="36" height="4" rx="2" fill="rgba(0,0,0,0.04)"/>
<rect x="1152" y="136" width="36" height="2" rx="1" fill="rgba(0,0,0,0.06)"/>
<rect x="1152" y="152" width="36" height="3" rx="1.5" fill="rgba(0,0,0,0.04)"/>
<rect x="1152" y="172" width="36" height="2" rx="1" fill="currentColor" fill-opacity="0.15"/>
<rect x="1152" y="192" width="36" height="4" rx="2" fill="rgba(0,0,0,0.04)"/>
<rect x="1152" y="216" width="36" height="2" rx="1" fill="rgba(0,0,0,0.06)"/>
<rect x="1152" y="236" width="36" height="3" rx="1.5" fill="rgba(0,0,0,0.04)"/>
<rect x="1152" y="256" width="36" height="2" rx="1" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="78" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="102" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="126" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="150" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="174" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="198" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="222" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="246" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="270" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="294" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="318" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="342" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="366" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="390" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="414" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="438" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="462" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="486" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="510" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="534" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="558" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="582" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="606" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="20" y="630" width="20" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="76" y="78" width="80" height="6" rx="3" fill="currentColor" fill-opacity="0.35"/>
<rect x="164" y="78" width="200" height="6" rx="3" fill="rgba(0,0,0,0.08)"/>
<rect x="76" y="102" width="40" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="124" y="102" width="180" height="6" rx="3" fill="rgba(0,0,0,0.1)"/>
<rect x="312" y="102" width="60" height="6" rx="3" fill="currentColor" fill-opacity="0.2"/>
<rect x="96" y="126" width="120" height="6" rx="3" fill="rgba(0,0,0,0.08)"/>
<rect x="224" y="126" width="80" height="6" rx="3" fill="rgba(0,0,0,0.05)"/>
<rect x="96" y="150" width="60" height="6" rx="3" fill="currentColor" fill-opacity="0.3"/>
<rect x="164" y="150" width="260" height="6" rx="3" fill="rgba(0,0,0,0.08)"/>
<rect x="96" y="174" width="300" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="96" y="198" width="160" height="6" rx="3" fill="rgba(0,0,0,0.08)"/>
<rect x="264" y="198" width="100" height="6" rx="3" fill="currentColor" fill-opacity="0.15"/>
<rect x="76" y="222" width="40" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="76" y="270" width="80" height="6" rx="3" fill="currentColor" fill-opacity="0.35"/>
<rect x="164" y="270" width="160" height="6" rx="3" fill="rgba(0,0,0,0.08)"/>
<rect x="76" y="294" width="40" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="124" y="294" width="220" height="6" rx="3" fill="rgba(0,0,0,0.1)"/>
<rect x="96" y="318" width="140" height="6" rx="3" fill="rgba(0,0,0,0.08)"/>
<rect x="244" y="318" width="60" height="6" rx="3" fill="currentColor" fill-opacity="0.2"/>
<rect x="312" y="318" width="100" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="96" y="342" width="80" height="6" rx="3" fill="currentColor" fill-opacity="0.25"/>
<rect x="184" y="342" width="200" height="6" rx="3" fill="rgba(0,0,0,0.08)"/>
<rect x="96" y="366" width="260" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="96" y="390" width="180" height="6" rx="3" fill="rgba(0,0,0,0.08)"/>
<rect x="96" y="414" width="120" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="224" y="414" width="80" height="6" rx="3" fill="currentColor" fill-opacity="0.15"/>
<rect x="76" y="438" width="40" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="76" y="462" width="40" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="76" y="486" width="80" height="6" rx="3" fill="currentColor" fill-opacity="0.35"/>
<rect x="164" y="486" width="140" height="6" rx="3" fill="rgba(0,0,0,0.08)"/>
<rect x="76" y="510" width="40" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="124" y="510" width="280" height="6" rx="3" fill="rgba(0,0,0,0.1)"/>
<rect x="96" y="534" width="200" height="6" rx="3" fill="rgba(0,0,0,0.08)"/>
<rect x="96" y="558" width="60" height="6" rx="3" fill="currentColor" fill-opacity="0.25"/>
<rect x="164" y="558" width="180" height="6" rx="3" fill="rgba(0,0,0,0.08)"/>
<rect x="96" y="582" width="240" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
<rect x="96" y="606" width="160" height="6" rx="3" fill="rgba(0,0,0,0.08)"/>
<rect x="76" y="630" width="40" height="6" rx="3" fill="rgba(0,0,0,0.06)"/>
</svg>
SVG
		,
		'user'      => <<<'SVG'
