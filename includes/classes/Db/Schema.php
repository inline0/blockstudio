 ...
 */
final readonly class Schema implements Definition {

	/**
	 * Constructor.
	 *
	 * @param array<string, array<string, mixed>|Definition> $fields     Schema fields.
	 * @param string|Storage                                 $storage    Storage backend.
	...
	public function __construct(
		...
		private string|Storage $storage = 'table',
	...
	public function to_array(): array {
		...
		$definition = array_merge(
			array(
				'storage' => $this->storage instanceof Storage ? $this->storage->value : $this->storage,
				'fields'  => $fields,
			),
			$this->extra
		);
