...
class Plugin {
	...
	private function load_classes(): void {
		...
		// Block tag renderer traits.
		require_once $classes_dir . 'block-tags-renderers/trait-paragraph-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-heading-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-list-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-quote-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-pullquote-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-code-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-preformatted-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-verse-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-image-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-gallery-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-audio-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-video-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-cover-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-embed-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-group-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-columns-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-separator-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-spacer-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-buttons-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-details-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-table-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-social-links-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-media-text-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-more-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-accordion-renderer.php';
		require_once $classes_dir . 'block-tags-renderers/trait-query-renderer.php';
	...
	private function init(): void {
		...
		add_action(
			'init',
			function () {
				if ( class_exists( 'Blockstudio\Rpc' ) ) {
					Rpc::init();
				}
